...
if ($data) {
    $params = [
        ...
        'dateTimeCancelTransmission' => $data['dateTimeCancelTransmission'],
        'dateTimeTransaction' => $data['dateTimeTransaction'],
        'originalDataElements' => $data['originalDataElements'],
        'sysRetRefNumber' => $data['sysRetRefNumber'],
        'idMotiveCancel' => $data['idMotiveCancel'],
        'descriptionMotiveCancel' => $data['descriptionMotiveCancel'],
    ];
    if ($post->cancel($params)) {
